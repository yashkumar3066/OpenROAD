...
_wrap_report_flute_tree(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  {
    try {
      stt::report_flute_tree(SWIG_STD_MOVE(arg1),SWIG_STD_MOVE(arg2),arg3); 
    }
    catch (std::bad_alloc &) {
      fprintf(stderr, "Error: out of memory.");
      exit(1);
...
_wrap_report_pd_tree(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  {
    try {
      stt::report_pd_tree(SWIG_STD_MOVE(arg1),SWIG_STD_MOVE(arg2),arg3,arg4); 
    }
    catch (std::bad_alloc &) {
      fprintf(stderr, "Error: out of memory.");
      exit(1);
...
_wrap_report_stt_tree(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  {
    try {
      stt::report_stt_tree(SWIG_STD_MOVE(arg1),SWIG_STD_MOVE(arg2),arg3,arg4); 
    }
    catch (std::bad_alloc &) {
      fprintf(stderr, "Error: out of memory.");
      exit(1);
...
_wrap_highlight_stt_tree(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  {
    try {
      stt::highlight_stt_tree(SWIG_STD_MOVE(arg1),SWIG_STD_MOVE(arg2),arg3,arg4); 
    }
    catch (std::bad_alloc &) {
      fprintf(stderr, "Error: out of memory.");
      exit(1);
...
_wrap_highlight_pd_tree(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  {
    try {
      stt::highlight_pd_tree(SWIG_STD_MOVE(arg1),SWIG_STD_MOVE(arg2),arg3,arg4); 
    }
    catch (std::bad_alloc &) {
      fprintf(stderr, "Error: out of memory.");
      exit(1);
...
_wrap_highlight_flute_tree(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  {
    try {
      stt::highlight_flute_tree(SWIG_STD_MOVE(arg1),SWIG_STD_MOVE(arg2)); 
    }
    catch (std::bad_alloc &) {
      fprintf(stderr, "Error: out of memory.");
      exit(1);
