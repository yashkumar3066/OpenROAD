...
_wrap_generate_ram_netlist_cmd(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"ooooooo:ram::generate_ram_netlist_cmd bytes_per_word word_count storage_cell_name tristate_cell_name inv_cell_name read_ports mask ",(void *)0,(void *)0,(void *)0,(void *)0,(void *)0,(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  ...
  if (!SWIG_IsOK(ecode7)) {
    SWIG_exception_fail(SWIG_ArgError(ecode7), "in method '" "generate_ram_netlist_cmd" "', argument " "7"" of type '" "bool""'");
  } 
  arg7 = static_cast< bool >(val7);
  {
    try {
      generate_ram_netlist_cmd(arg1,arg2,(char const *)arg3,(char const *)arg4,(char const *)arg5,arg6,arg7); 
    }
    catch (std::bad_alloc &) {
