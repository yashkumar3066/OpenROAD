...
_wrap_get_heatmap_string(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  {
    try {
      result = (char *)get_heatmap_string((std::string const &)*arg1,(std::string const &)*arg2); 
    }
    catch (std::bad_alloc &) {
      fprintf(stderr, "Error: out of memory.");
      exit(1);
...
static swig_type_info _swigt__p_std__mapT_std__string_bool_std__lessT_std__string_t_t = {"_p_std__mapT_std__string_bool_std__lessT_std__string_t_t", "std::map< std::string,bool,std::less< std::string > > *|std::map< std::string,bool > *", 0, 0, (void*)&_wrap_class_std_map_Sl_std_string_Sc_bool_Sg_, 0};
